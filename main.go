...
type Walking struct {
	Training
	Height float64 // height of the user in centimeters
}
...
func (w Walking) Calories() float64 {
	...
	return (CaloriesWeightMultiplier*w.Weight + (meanSpeedMsec*meanSpeedMsec/heightM)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
